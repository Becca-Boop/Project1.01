...
namespace Project
{
    ...
    public class SquareGrid
    {
        ...
        //                GameGlobals.normalEffect.Parameters["filterColor"].SetValue(Color.White.ToVector4());
        //                GameGlobals.normalEffect.CurrentTechnique.Passes[0].Apply();
        ...
        //                        {
        //                            GameGlobals.normalEffect.Parameters["filterColor"].SetValue(Color.Red.ToVector4());
        //                            GameGlobals.normalEffect.CurrentTechnique.Passes[0].Apply();

        //                        }
        //                        else if (slots[j][k].filled)
        //                        {
        //                            GameGlobals.normalEffect.Parameters["filterColor"].SetValue(Color.DarkGray.ToVector4());
        //                            GameGlobals.normalEffect.CurrentTechnique.Passes[0].Apply();
        //                        }
        //                        else
        //                        {
